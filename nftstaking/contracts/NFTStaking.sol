...
import "./interfaces/IMoonToken.sol";
import "./interfaces/IMoonNFT.sol";

/// @title the MoonNFT staking vault
/// @author @nt96325
/// @notice this vault allwos users to stake their MoonNFT tokens and earn daily rewards based on their overall staking period,
/// the rewards are distributed in the form of our own ERC20 token 'MoonToken'
/// @dev this contract must be set as controller in the 'MoonToken' contract to enable ERC20 rewards minting
...
contract NFTStaking is IERC721Receiver {
    ...
    IMoonToken immutable token;
    IMoonNFT immutable nft;
    ...
    constructor(address _nftAddress, address _tokenAddress) {
        nft = IMoonNFT(_nftAddress);
        token = IMoonToken(_tokenAddress);
    }
